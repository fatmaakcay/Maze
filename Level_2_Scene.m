...
-(id)initWithSize:(CGSize)size
{
    if (self = [super initWithSize:size]) {
        ...
        dont_touch_this1 = [SKSpriteNode spriteNodeWithImageNamed:@"Level2_Maze1.png"];
        dont_touch_this1.position = CGPointMake(350,265);
        
        dont_touch_this2 = [SKSpriteNode spriteNodeWithImageNamed:@"Level2_Maze2.png"];
        dont_touch_this2.position = CGPointMake(-25,265);
        
        dont_touch_this3 = [SKSpriteNode spriteNodeWithImageNamed:@"Level2_Maze3.png"];
        dont_touch_this3.position = CGPointMake(210,600);
        
        dont_touch_this4 = [SKSpriteNode spriteNodeWithImageNamed:@"Level2_Maze4.png"];
        dont_touch_this4.position = CGPointMake(235,-50);
